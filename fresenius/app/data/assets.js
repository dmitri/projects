var data = [{
		...
		"App_Name": "AirWatch",
		"App_Description": "VMware AirWatch® Enterprise Mobility Management (EMM) is a scaleable platform that integrates with your existing systems and manages all devices from one console.",
	...
	},
	{
		...
		"App_Description": "The scope of the interface is to receive and convert CHAIRSIDE order and result data into the HL7 based equivalent records required by the Soarian Clinical application, within thirty minutes of the ‘close shift’ CHAIRSIDE event. • Core data within the interface will include data related:o Results, o Order status update data• Provide a data transfer mechanism between the CHAIRSIDE platform and the iHub platform.",
		"Business_Owner": "Ron Rodgers",
		"IT_SPONSOR": "Bill Fink, Tess Hetzel",
		"IT_OWNER": "Bill Rhoden, Darshan Patel, Michelle Goodman"
	},
	...
	},
	{
		...
		"App_Description": "The Order Status Update (OSU) Processing to eCC interface addresses the passing of data from the integrations platform to eCC, for sending order status update.  It also supports providing data for the Order Schedule Manager Application.",
		"Business_Owner": "Ron Rodgers",
		"IT_SPONSOR": "Bill Fink, Tess Hetzel",
		"IT_OWNER": "Bill Rhoden, Darshan Patel, Michelle Goodman"
	},
